...
var renameProps = function renameProps(nameMap) {
  var hoc = mapProps(function (props) {
    return _extends(
      ...
      mapKeys(pick(props, keys(nameMap)), function (_, oldName) {
...
/*var isClassComponent = function isClassComponent(Component$$1) {
  return Boolean(
    Component$$1 &&
      ...
      typeof Component$$1.prototype.render === 'function',
  );
};*/
/*
...
var fromRenderProps = function fromRenderProps(
    ...
    var FromRenderProps = function FromRenderProps(ownerProps) {
      ...
      return renderPropsFactory(
        ...
        (_renderPropsFactory[renderPropName] = function () {
          return baseFactory(
            _extends({}, ownerProps, propsMapper.apply(void 0, arguments)),
          );
        }),
        _renderPropsFactory),
      );
