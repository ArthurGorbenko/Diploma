 ...
 */
final class Version20200601222001 extends AbstractMigration
{
  ...
  public function up(Schema $schema): void
  {
    ...
    $this->addSql('ALTER TABLE slide ADD disabled TINYINT(1) NOT NULL');
    $this->addSql(
  ...
  public function down(Schema $schema): void
  {
    ...
    $this->addSql('ALTER TABLE slide DROP disabled');
    $this->addSql(
