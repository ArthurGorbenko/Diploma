 ...
 */
final class Version20200512173225 extends AbstractMigration
{
  ...
  public function down(Schema $schema): void
  {
    ...
    $this->addSql(
      'ALTER TABLE `option` ADD default_value VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`'
    );
    $this->addSql(
      'ALTER TABLE product CHANGE shop_id shop_id INT DEFAULT NULL, CHANGE category_id category_id INT DEFAULT NULL'
    );
