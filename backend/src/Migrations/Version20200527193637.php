 ...
 */
final class Version20200527193637 extends AbstractMigration
{
  ...
  public function up(Schema $schema): void
  {
    ...
    $this->addSql(
      'ALTER TABLE shop ADD subscription_date DATE DEFAULT NULL, CHANGE logo logo VARCHAR(255) DEFAULT NULL, CHANGE email email VARCHAR(255) DEFAULT NULL, CHANGE address address VARCHAR(255) DEFAULT NULL, CHANGE phone phone VARCHAR(255) DEFAULT NULL, CHANGE owner_first_name owner_first_name VARCHAR(255) DEFAULT NULL, CHANGE owner_last_name owner_last_name VARCHAR(255) DEFAULT NULL, CHANGE owner_phone owner_phone VARCHAR(255) DEFAULT NULL, CHANGE payment_frequency payment_frequency VARCHAR(255) DEFAULT NULL, CHANGE pin pin SMALLINT DEFAULT NULL'
    );
    $this->addSql(
