 ...
 */
final class Version20200515164147 extends AbstractMigration
{
  ...
  public function up(Schema $schema): void
  {
    ...
    $this->addSql(
      'ALTER TABLE `option` ADD translation_key VARCHAR(255) NOT NULL, DROP translation_id, CHANGE default_value default_value JSON NOT NULL, CHANGE supported_values supported_values JSON NOT NULL'
    );
    $this->addSql(
  ...
  public function down(Schema $schema): void
  {
    ...
    $this->addSql(
      'ALTER TABLE `option` ADD translation_id INT NOT NULL, DROP translation_key, CHANGE default_value default_value LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_bin`, CHANGE supported_values supported_values LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_bin`'
    );
    $this->addSql(
      'ALTER TABLE product CHANGE shop_id shop_id INT DEFAULT NULL, CHANGE category_id category_id INT DEFAULT NULL'
    );
