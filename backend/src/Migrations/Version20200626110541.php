 ...
 */
final class Version20200626110541 extends AbstractMigration
{
  ...
  public function up(Schema $schema): void
  {
    ...
    $this->addSql(
      'CREATE TABLE slide_event_image (id INT AUTO_INCREMENT NOT NULL, event_image_id INT NOT NULL, INDEX IDX_730DC0147B49CCBD (event_image_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB'
    );
    $this->addSql(
      'ALTER TABLE slide_event_image ADD CONSTRAINT FK_730DC0147B49CCBD FOREIGN KEY (event_image_id) REFERENCES event_image (id)'
    );
  ...
  public function down(Schema $schema): void
  {
    ...
    $this->addSql('DROP TABLE slide_event_image');
    $this->addSql(
