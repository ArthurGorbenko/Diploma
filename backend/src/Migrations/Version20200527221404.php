 ...
 */
final class Version20200527221404 extends AbstractMigration
{
  ...
  public function up(Schema $schema): void
  {
    ...
    $this->addSql(
      'CREATE TABLE slide_video (id INT AUTO_INCREMENT NOT NULL, slide_id INT NOT NULL, video_link VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_FD4E0C0FDD5AFB87 (slide_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB'
    );
    $this->addSql(
      'ALTER TABLE slide_video ADD CONSTRAINT FK_FD4E0C0FDD5AFB87 FOREIGN KEY (slide_id) REFERENCES slide (id) ON DELETE CASCADE'
    );
  ...
  public function down(Schema $schema): void
  {
    ...
    $this->addSql('DROP TABLE slide_video');
    $this->addSql(
