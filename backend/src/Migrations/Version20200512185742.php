 ...
 */
final class Version20200512185742 extends AbstractMigration
{
  ...
  public function up(Schema $schema): void
  {
    ...
    $this->addSql(
      'ALTER TABLE `option` ADD supported_values JSON NOT NULL, CHANGE default_value default_value JSON NOT NULL'
    );
    $this->addSql(
  ...
  public function down(Schema $schema): void
  {
    ...
    $this->addSql(
      'ALTER TABLE `option` DROP supported_values, CHANGE default_value default_value LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_bin`'
    );
    $this->addSql(
      'ALTER TABLE product CHANGE shop_id shop_id INT DEFAULT NULL, CHANGE category_id category_id INT DEFAULT NULL'
    );
