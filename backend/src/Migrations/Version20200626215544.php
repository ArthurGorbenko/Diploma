 ...
 */
final class Version20200626215544 extends AbstractMigration
{
  ...
  public function up(Schema $schema): void
  {
    ...
    $this->addSql('ALTER TABLE slide_event_image ADD slide_id INT NOT NULL');
    $this->addSql(
      'ALTER TABLE slide_event_image ADD CONSTRAINT FK_730DC014DD5AFB87 FOREIGN KEY (slide_id) REFERENCES slide (id)'
    );
    $this->addSql(
      'CREATE UNIQUE INDEX UNIQ_730DC014DD5AFB87 ON slide_event_image (slide_id)'
    );
    $this->addSql(
  ...
  public function down(Schema $schema): void
  {
    ...
    $this->addSql(
      'ALTER TABLE slide_event_image DROP FOREIGN KEY FK_730DC014DD5AFB87'
    );
    $this->addSql('DROP INDEX UNIQ_730DC014DD5AFB87 ON slide_event_image');
    $this->addSql('ALTER TABLE slide_event_image DROP slide_id');
    $this->addSql(
