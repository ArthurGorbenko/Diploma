 ...
 */
final class Version20200525223238 extends AbstractMigration
{
  ...
  public function up(Schema $schema): void
  {
    ...
    $this->addSql(
      'ALTER TABLE shop ADD email VARCHAR(255) DEFAULT NULL, ADD address VARCHAR(255) DEFAULT NULL, ADD phone VARCHAR(255) DEFAULT NULL, ADD owner_first_name VARCHAR(255) DEFAULT NULL, ADD owner_last_name VARCHAR(255) DEFAULT NULL, ADD owner_phone VARCHAR(255) DEFAULT NULL, ADD payment_frequency VARCHAR(255) DEFAULT NULL, ADD pin SMALLINT DEFAULT NULL, CHANGE logo logo VARCHAR(255) DEFAULT NULL'
    );
    $this->addSql(
  ...
  public function down(Schema $schema): void
  {
    ...
    $this->addSql(
      'ALTER TABLE shop DROP email, DROP address, DROP phone, DROP owner_first_name, DROP owner_last_name, DROP owner_phone, DROP payment_frequency, DROP pin, CHANGE logo logo VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`'
    );
    $this->addSql(
