 ...
 */
final class Version20200519222921 extends AbstractMigration
{
  ...
  public function up(Schema $schema): void
  {
    ...
    $this->addSql(
      'ALTER TABLE option_value DROP FOREIGN KEY FK_249CE55CBF02008E'
    );
    $this->addSql('ALTER TABLE option_value CHANGE value value JSON NOT NULL');
    $this->addSql(
      'ALTER TABLE option_value ADD CONSTRAINT FK_249CE55CBF02008E FOREIGN KEY (referred_option_id) REFERENCES `option` (id) ON DELETE CASCADE'
    );
    $this->addSql(
